namespace System {
	...
	[Flags, Name("CASEINSENSITIVE", "Array.CASEINSENSITIVE", ""), NameAttribute("DESCENDING", "Array.DESCENDING", ""),
	 NameAttribute("NUMERIC", "Array.NUMERIC", ""), NameAttribute("RETURNINDEXEDARRAY", "Array.RETURNINDEXEDARRAY", ""),
	...
	public class Array : IEnumerable {
		...
		/// </summary>
		public Array(int numElements = int.MAX_VALUE) {
			return;
		}
