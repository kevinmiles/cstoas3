namespace flash.net {
	...
	public class NetStream : EventDispatcher {
		...
		/// </summary>
		public double maxPauseBufferTime {
			get;
			set;
		}
		...
		/// </summary>
		public void play(object name, float start, float len, object reset) {}
		public void play(object name, float start, float len) {}
		public void play(object name, float start) {}
