namespace flash.text {
	...
	public class TextField : InteractiveObject {
		...
		/// </summary>
		[EventAttribute("TextEvent.TEXT_INPUT")]
		...
		/// </summary>
		public bool useRichTextClipboard {
			get;
			set;
		}
